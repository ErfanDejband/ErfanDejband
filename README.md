...
<ul>
  ...
  <li>🚀 <b>Currently working on:</b>
    <br>&nbsp;&nbsp;- AI agent systems & GitHub Copilot plugins for engineering workflows
    <br>&nbsp;&nbsp;- TinyML deployment on MCUs (edge inference for medical devices)
    <br>&nbsp;&nbsp;- CI/CD automation frameworks for embedded firmware teams
  </li>
  
  <li>👀 <b>I am interested in:</b>
    <br>&nbsp;&nbsp;- Deploying deep learning on resource-constrained edge devices
    <br>&nbsp;&nbsp;- Multi-agent AI workflow design and orchestration
    <br>&nbsp;&nbsp;- Signal processing + fiber optic sensing systems
    <br>&nbsp;&nbsp;- MLOps and production ML pipelines
  </li>
  
  <li>💜 <b>Also interested in:</b>
    <br>&nbsp;&nbsp;- Fiber Bragg Grating (FBG) sensors
    <br>&nbsp;&nbsp;- DSP (FFT, spectral estimation, adaptive filtering)
    <br>&nbsp;&nbsp;- Optic sensors and optic communication
  </li>
</ul>
</div>
</br>
